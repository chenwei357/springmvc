					...
					<ul class="tab">
						...
						<ul class="tabContent" style="display: block;">
							<c:forEach items="${plist}" var="product">
								<li>
									<a href="${pageContext.request.contextPath}/product/detail?pid=${product.pid}" target="_blank"><img src="${pageContext.request.contextPath}/${product.image}" style="display: block;" /></a>
								</li>
							</c:forEach>
						</ul>
...
<!-- 					<div class="newProductAd">
						 ...
						 <ul class="tabContent" style="display: block;">
						 	<c:forEach items="${nlist}" var="nlist">
								<li>
									<a href="${pageContext.request.contextPath}/product/detail?pid=${nlist.pid}" target="_blank"><img src="${pageContext.request.contextPath}/${nlist.image}" data-original="http://storage.shopxx.net/demo-image/3.0/201301/b499fb5e-999f-431b-a375-172ee09e4a3e-thumbnail.jpg" style="display: block;" /></a>
								</li>
							</c:forEach>
						</ul>
						<ul class="tabContent" style="display: none;">
