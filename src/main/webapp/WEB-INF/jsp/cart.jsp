		...
		<div class="span24">
			<div class="step step1">
				...
				<table>
					<tbody><tr>
						...
						<tr>
							...
							<td>
								<a href="${pageContext.request.contextPath}/cart/delete?pid=${cartItem.product.pid}" class="delete">删除</a>
							</td>
						</tr>
						</c:forEach>
				</tbody></table>
				...
				<div class="total">
					...
					商品金额: <strong id="effectivePrice">￥${cart.total}</strong>
				</div>
				<div class="bottom">
					<a href="${pageContext.request.contextPath}/cart/clearCart" id="clear" class="clear">清空购物车</a>
					<a href="${pageContext.request.contextPath}/order/save" id="submit" class="submit">提交订单</a>
				</div>
		</div>
		</c:if>
		<c:if test="${cart.cartItems.size() == 0}">
			<div class="span24">
				<div class="step step1">
					<span><h2 style="color:red;margin:30px 5%;">亲!您还没有购物!请先去购物!</h2></span>
				</div>
			</div>
		</c:if>
	</div>
