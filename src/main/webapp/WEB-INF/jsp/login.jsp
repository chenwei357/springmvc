		...
		<div class="span5">
			<div class="logo">
				<a href="${pageContext.request.contextPath}/index"> <img
					src="${pageContext.request.contextPath}/image/r___________renleipic_01/logo.gif" alt="网上商城" />
				</a>
			</div>
		</div>
		<div class="span9">
						...
						<table>
							<tbody>
								<tr>
									<th></th>
									<td>
										<span style="color:red; font-size: 16px;width:100%">${errors}</span>
									</td>
								</tr>
								<tr>
									<th>用户名:</th>
