			...
			<div class="hotProductCategory">
				<c:forEach items="${clist}" var="category">
					<dl>
						<dt>
							<a
								href="${pageContext.request.contextPath}/product/list?cid=${category.cid}&pageNo=1">${category.cname}</a>
						</dt>
