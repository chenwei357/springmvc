...
public class MailUtils {
	...
	public static void sendMail(String to, String code) {
		...
		try {
			...
			// 设置邮件正文:
			message.setContent(
					"<h1>购物商城官方激活邮件!点下面链接完成激活操作!</h1><h3><a href='http://119.29.107.160:8080/springmvc/user/active?code="
							+ code + "'>http://119.29.107.160:8080/springmvc/user/active?code=" + code + "</a></h3>",
